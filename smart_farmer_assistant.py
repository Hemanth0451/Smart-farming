...
# --- Crop Info Data (from crop_data.py) ---
crop_info = {
...
def recommend_fertilizer(n, p, k):
    ...
    if p < 40:
        recommendation += "Phosphorus is low. Use SSP. "
    elif p > 60:
        recommendation += "Phosphorus is high. Avoid over-fertilizing. "
    if k < 40:
        recommendation += "Potassium is low. Use MOP. "
    elif k > 60:
        recommendation += "Potassium is high. Reduce potash-based fertilizers. "
    return recommendation or "NPK levels are optimal."
...
if menu == "Dashboard":
    ...
    if query:
        response = "This is a demo. Replace with OpenAI/GPT/Rasa API call."
        st.write(f"🤖: {response}")
